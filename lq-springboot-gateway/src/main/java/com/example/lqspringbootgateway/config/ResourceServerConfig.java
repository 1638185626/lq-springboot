package com.example.lqspringbootgateway.config;
...
public class ResourceServerConfig {
    ...
    public ReactiveJwtDecoder jwtDecoder() throws IOException, NoSuchAlgorithmException, InvalidKeySpecException {
        Resource resource = new FileSystemResource("/Users/liuqing01/IdeaProjects/dev/lq-springboot/lq-springboot-gateway/src/main/resources/new-authoriza-server-public-key.pem");
